...
INTEGRATED WITH: Flat Staking Engine ($10)
"""
...
# Windows terminals commonly default to cp1252, while bot diagnostics use
# Unicode symbols. Configure both console streams to avoid logging failures.
...
def main():
    ...
    logger.info(f"📊 Flat Staking Engine loaded: ${STAKE_SEQUENCE[0]:.2f}")
    ...
    send_telegram(
        ...
        "━━━━━━━━━━━━━━━━━━━━━\n"
        f"📊 **Flat Staking Engine Active: ${STAKE_SEQUENCE[0]:.2f}**\n"
